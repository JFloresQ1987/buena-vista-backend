    ...
    for (let i = 0; i < lista.length; i++) {
      ...
      for (let j = 0; j < lista[i].pagos.length; j++) {
        ...
        monto_ahorro_inicial_pagado +=
          lista[i].pagos[j].monto_ahorro_inicial || 0;
        monto_ahorro_voluntario_pagado +=
          lista[i].pagos[j].monto_ahorro_voluntario || 0;
        monto_ahorro_programado_pagado +=
          lista[i].pagos[j].monto_ahorro_programado || 0;
        monto_amortizacion_capital_pagado +=
          lista[i].pagos[j].monto_amortizacion_capital || 0;
...
const pagar_operacion_financiera = async (req, res) => {
  ...
  try {
    ...
    if (!caja_diario) {
      ...
      if (ultimo_caja_diario) {
        apertura_caja_diario.cantidad_diez_centimos_apertura =
          ultimo_caja_diario.cantidad_diez_centimos_cierre;
        apertura_caja_diario.cantidad_veinte_centimos_apertura =
          ultimo_caja_diario.cantidad_veinte_centimos_cierre;
        apertura_caja_diario.cantidad_cincuenta_centimos_apertura =
          ultimo_caja_diario.cantidad_cincuenta_centimos_cierre;
        apertura_caja_diario.cantidad_un_sol_apertura =
          ultimo_caja_diario.cantidad_un_sol_apertura;
        apertura_caja_diario.cantidad_cinco_soles_apertura =
          ultimo_caja_diario.cantidad_cinco_soles_cierre;
        apertura_caja_diario.cantidad_diez_soles_apertura =
          ultimo_caja_diario.cantidad_diez_soles_cierre;
        apertura_caja_diario.cantidad_veinte_soles_apertura =
          ultimo_caja_diario.cantidad_veinte_soles_cierre;
        apertura_caja_diario.cantidad_cincuenta_soles_apertura =
          ultimo_caja_diario.cantidad_cincuenta_soles_cierre;
        apertura_caja_diario.cantidad_dos_soles_apertura =
          ultimo_caja_diario.cantidad_dos_soles_cierre;
        apertura_caja_diario.cantidad_cien_soles_apertura =
          ultimo_caja_diario.cantidad_cien_soles_cierre;
        apertura_caja_diario.cantidad_discientos_soles_apertura =
          ultimo_caja_diario.cantidad_discientos_soles_cierre;
    ...
    dato_recibo.numero_recibo =
      "I-" + correlativo_recibo.toString().padStart(8, "00000000");
    ...
    for (let i = 0; i < cuotas.length; i++) {
      const cuota = await OperacionFinancieraDetalle.findById({
        _id: cuotas[i],
      });
      ...
      for (let i = 0; i < cuota.pagos.length; i++) {
        ...
        monto_ahorro_voluntario_pagado +=
          cuota.pagos[i].monto_ahorro_voluntario || 0;
        monto_ahorro_programado_pagado +=
          cuota.pagos[i].monto_ahorro_programado || 0;
        monto_amortizacion_capital_pagado +=
          cuota.pagos[i].monto_amortizacion_capital || 0;
      ...
      let monto_ahorro_inicial_a_pagar =
        cuota.monto_ahorro_inicial - monto_ahorro_inicial_pagado;
      let monto_ahorro_voluntario_a_pagar = Number(
        monto_ahorro_voluntario_actual
      ); //cuota.monto_ahorro_voluntario - monto_ahorro_voluntario_pagado;
      let monto_ahorro_programado_a_pagar =
        cuota.monto_ahorro_programado - monto_ahorro_programado_pagado;
      let monto_amortizacion_capital_a_pagar =
        cuota.monto_amortizacion_capital - monto_amortizacion_capital_pagado;
      ...
      const monto_total_cuota_a_pagar =
        monto_gasto_a_pagar +
      ...
      if (monto_total_cuota_a_pagar <= monto_recibido_actual) {
        ...
        if (monto_recibido_actual >= 0.1) {
          ...
          if (
            ...
            monto_ahorro_voluntario_a_pagar <= monto_recibido_actual
          ) {
          ...
          if (
            monto_recibido_actual > 0 &&
            monto_mora_a_pagar <= monto_recibido_actual
          ) {
          ...
          if (
            monto_recibido_actual > 0 &&
            monto_interes_a_pagar <= monto_recibido_actual
          ) {
          ...
          if (
            monto_recibido_actual > 0 &&
            monto_amortizacion_capital_a_pagar <= monto_recibido_actual
          ) {
          ...
          if (
            monto_recibido_actual > 0 &&
            monto_ahorro_programado_a_pagar <= monto_recibido_actual
          ) {
          ...
          if (
            monto_recibido_actual > 0 &&
            monto_ahorro_inicial_a_pagar <= monto_recibido_actual
          ) {
          ...
          if (
            monto_recibido_actual > 0 &&
            monto_gasto_a_pagar <= monto_recibido_actual
          ) {
          ...
          monto_total +=
            monto_gasto_a_amortizar +
            monto_ahorro_inicial_a_amortizar +
            // monto_ahorro_voluntario_a_amortizar + monto_total_cuota +
            monto_ahorro_voluntario_a_amortizar +
            monto_ahorro_programado_a_amortizar +
            monto_amortizacion_capital_a_amortizar +
            monto_interes_a_amortizar +
    ...
    const cuotas_pendientes = await OperacionFinancieraDetalle.findOne({
      operacion_financiera: operacion_financiera,
      estado: "Vigente",
      es_borrado: false,
    });
    ...
    if (!cuotas_pendientes) {
      ...
      const model_operacion_financiera = await OperacionFinanciera.findById({
